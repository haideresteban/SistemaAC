...
class Categoria {
    ...
    //metodo de la clase en .js
    agregarCategoria(id, funcion) {
        if (this.nombre === "") {
            document.getElementById("Nombre").focus();//obtiene del formiulario el id de el que se llame como en las comillas 
        } else {
            if (this.descripcion === "") {
    ...
    editarCategoria(id, funcion) {
        ...
        //liberar la memoria del navegador(local) de los datos 
