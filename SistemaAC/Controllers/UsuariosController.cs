...
namespace SistemaAC.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public UsuariosController(ApplicationDbContext context, UserManager<ApplicationUser> userManage, RoleManager<IdentityRole> roleManager)
        {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            //obtengo los usuarios y lo paso al objeto
        ...
        public async Task<string> EditUsuario(string id, string userName, string email, string phoneNumber, int accessFailedCount, string concurrencyStamp, bool emailConfirmed,
